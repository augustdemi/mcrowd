...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.name = '%s_pred_len_%s_zS_%s_embedding_dim_%s_encoder_h_dim_%s_mlp_dim_%s_pool_dim_%s_lr_%s' % \
                    (args.dataset_name, args.pred_len, args.zS_dim, args.embedding_dim, args.encoder_h_dim, args.mlp_dim, args.pool_dim, args.lr_VAE)
        ...
        self.decoder_h_dim = args.encoder_h_dim + args.pool_dim + args.zS_dim
