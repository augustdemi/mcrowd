...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            lg_cvae_path = 'sdd.lgcvae_enc_block_1_fcomb_block_2_wD_20_lr_0.001_lg_klw_1.0_a_0.25_r_2.0_fb_0.5_anneal_e_20_aug_1_run_18'
            lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_20000_lg_cvae.pt')
            if self.device == 'cuda':
            ...
            for batch in data_loader:
                ...
                if loss:
                    ...
                    for i in range(3):
                        ...
                        normalized_recon_sg_heat.append(
                            F.normalize(sg_map.view((sg_map.shape[0], sg_map.shape[1], -1))))
...
#4444444444444444444t
    ...
    def load_checkpoint(self):
        ...
        if self.device == 'cuda':
            ...
            # self.lg_cvae = torch.load(lg_cvae_path, map_location='cpu')
            sg_unet_path = 'ckpts/sdd.sg_enc_block_1_fcomb_block_2_wD_20_lr_0.001_lg_klw_1.0_a_0.25_r_2.0_fb_0.5_anneal_e_20_load_e_1_aug_1_scael_1.0_run_5/iter_25000_sg_unet.pt'
