...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.name = '%s_enc_block_%s_fcomb_block_%s_wD_%s_lr_%s' % \
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            obs_heat_map, lg_heat_map = self.make_heatmap(sampled_local_ic, sampled_local_map, sampled_congest_map, aug=True)
