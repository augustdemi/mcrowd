...
class Solver(object):
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            (muy, log_vary) \
                = self.encoderMy(map_feat, obs_traj_st[-1], fut_vel_st, seq_start_end, local_map, train=True)
    ...
    def evaluate_dist(self, data_loader, loss=False):
        ...
        with torch.no_grad():
            ...
            while not data_loader.is_epoch_end():
                ...
                if loss:
                    (muy, log_vary) \
                        = self.encoderMy(map_feat, obs_traj_st[-1], fut_vel_st, seq_start_end, local_map, train=False)
