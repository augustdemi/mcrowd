...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_26000_lgcvae.pt')
...
#4444444444444444444t
                ...
                pred_sg_heat = F.sigmoid(
                    self.sg_unet.forward(torch.cat([obs_heat_map, pred_lg_prior], dim=1)))
    ...
    def all_evaluation(self, data_loader, lg_num=5, traj_num=4):
        self.set_mode(train=False)
        total_traj = 0
