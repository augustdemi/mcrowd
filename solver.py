...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        lg_cvae_path = 'nu.lgcvae_enc_block_1_fcomb_block_2_wD_20_lr_0.0001_lg_klw_1.0_a_0.25_r_2.0_fb_0.5_anneal_e_10_aug_1_llprior_0.0_run_2'
        lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_28000_lg_cvae.pt')
