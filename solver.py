...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        lg_cvae_path = 'nu.lgcvae_enc_block_1_fcomb_block_2_wD_10_lr_0.001_lg_klw_1.0_a_0.25_r_2.0_fb_4.0_anneal_e_10_aug_1_llprior_0.0_run_3'
        lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_41000_lg_cvae.pt')
