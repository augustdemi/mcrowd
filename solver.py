...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            if args.load_e > 0:
                lg_cvae_path = 'large_real.lg.ae_enc_block_%s_fcomb_block_%s_wD_10_lr_0.0001_a_0.25_r_2.0_run_%s' % (args.no_convs_per_block, args.no_convs_fcomb, args.run_id)
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            if epoch > 20 and (iteration % (iter_per_epoch * 10) == 0):
