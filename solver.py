...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            if args.load_e > 0:
                lg_cvae_path = 'pathseq.lg.ae_enc_block_1_fcomb_block_2_wD_10_lr_0.0001_a_0.25_r_2.0_run_0'
                lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_6660_lg_cvae.pt')
