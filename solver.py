...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.name = '%s_enc_block_%s_fcomb_block_%s_wD_%s_lr_%s_lg_klw_%s_a_%s_r_%s_fb_%s_anneal_e_%s_load_e_%s_aug_%s' % \
                    (args.dataset_name, args.no_convs_per_block, args.no_convs_fcomb, args.w_dim, args.lr_VAE,
                     args.lg_kl_weight, args.alpha, args.gamma, args.fb, args.anneal_epoch, args.load_e, args.aug)
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            sg_path = 'ckpts/sg_enc_block_1_fcomb_block_2_wD_10_lr_0.001_lg_klw_1_a_0.25_r_2.0_fb_2.0_anneal_e_10_load_e_1_run_1/iter_20000_lg_cvae.pt'
            if self.device == 'cuda':
            ...
            lg_cvae_path = 'sdd.lgcvae_enc_block_1_fcomb_block_2_wD_20_lr_0.001_lg_klw_1_a_0.25_r_2.0_fb_0.5_anneal_e_20_aug_1_run_13'
            lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_9600_lg_cvae.pt')
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            # recon_sg_heat = F.normalize(recon_sg_heat.view((recon_sg_heat.shape[0], recon_sg_heat.shape[1], -1)))
