...
class Solver(object):
    ...
    def load_checkpoint(self):
        ...
        if self.device == 'cuda':
            ...
            lg_cvae_path = 'lgcvae.' + self.dataset_name + '_enc_block_1_fcomb_block_2_wD_20_lr_0.001_a_0.25_r_2.0_skip_0_run_8'
            lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_5400_lg_cvae.pt')
