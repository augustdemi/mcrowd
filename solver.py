...
class Solver(object):
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            cos_sim1 = torch.cosine_similarity(obs_vec, pred_vec.detach()).sum().div(batch_size)
            ...
            if (iteration > 0):
                if self.viz_on and (iteration % self.viz_ll_iter == 0):
                    ...
                    self.line_gather.insert(iter=iteration,
                                            ...
                                            l2_lg_pos_loss=cum_l2_dist_loss/b,
                                            cos_sim1=cum_cos_sim1/b,
                                            cos_sim2=cum_cos_sim2/b,
                                            )
    ...
    def load_checkpoint(self):
        ...
        if self.device == 'cuda':
            ...
            lg_cvae_path = './ckpts/lgcvae_enc_block_1_fcomb_block_2_wD_10_lr_0.001_lg_klw_1.0_a_0.25_r_2.0_fb_0.5_anneal_e_10_load_e_1_pos_0.0_v1_0.0_2.0_v2_0.0_2.0_run_312/iter_48910_lg_cvae.pt'
            self.lg_cvae = torch.load(lg_cvae_path, map_location='cpu')
