...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        lg_cvae_path = 'large.lgcvae_enc_block_1_fcomb_block_2_wD_10_lr_0.0001_lg_klw_1.0_a_0.25_r_2.0_fb_2.0_anneal_e_10_load_e_3_run_2'
        lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_30_lg_cvae.pt')
        if self.device == 'cuda':
    ...
    def train(self):
        ...
        for iteration in range(start_iter, self.max_iter + 1):
            ...
            obs_heat_map, sg_heat_map, lg_heat_map = self.make_heatmap(sampled_local_ic, sampled_local_map, aug=True)
