...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        self.load_name = '%s_enc_block_%s_fcomb_block_%s_wD_%s_lr_0.0001_lg_klw_%s_a_%s_r_%s_fb_%s_anneal_e_%s_aug_%s' % \
                    (args.dataset_name, args.no_convs_per_block, args.no_convs_fcomb, args.w_dim,
                     args.lg_kl_weight, args.alpha, args.gamma, args.fb, args.anneal_epoch, args.aug)
        self.load_dir = os.path.join("ckpts", self.load_name)
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            if args.load_e > 0:
                ...
                lg_cvae_path = 'ckpts/sdd.lgcvae.ae_enc_block_1_fcomb_block_2_wD_20_lr_0.001_a_0.25_r_2.0_aug_1_run_23/' \
                               'iter_5000_lg_cvae.pt'
