...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if self.ckpt_load_iter == 0 or args.dataset_name =='all':  # create a new model
            ...
            if args.load_e > 0:
                lg_cvae_path = 'large.lg.ae_enc_block_%s_fcomb_block_%s_wD_10_lr_0.0001_k_%s_run_%s' % (args.no_convs_per_block, args.no_convs_fcomb, args.k_fold, args.run_id)
        ...
        with torch.no_grad():
            ...
            for batch in data_loader:
                ...
                lg_fde.append(torch.sqrt(((torch.stack(pred_lg_wc20)
                                           - fut_traj[-1,:,:2].unsqueeze(0).repeat((num_p,1,1)))**2).sum(-1))) # 20, 3, 4, 2
