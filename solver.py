...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        lg_cvae_path = 'sdd.lgcvae_enc_block_1_fcomb_block_2_wD_20_lr_0.0001_lg_klw_1.0_a_0.25_r_2.0_fb_5.0_anneal_e_0_aug_1_run_23'
        lg_cvae_path = os.path.join('ckpts', lg_cvae_path, 'iter_18500_lg_cvae.pt')
        if self.device == 'cuda':
