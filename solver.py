...
class Solver(object):
    ...
    def __init__(self, args):
        ...
        if args.load_e > 0:
            lg_cvae_path = 'large.lg.ae_bs_%s_enc_block_%s_fcomb_block_%s_wD_10_lr_0.0001_k_%s_run_9' % (
                args.batch_size, args.no_convs_per_block, args.no_convs_fcomb, args.k_fold)
