...
class Decoder(nn.Module):
    ...
    def forward(self, seq_start_end, last_obs_state, enc_h_feat, z, sg, fut_traj=None):
        """
        Inputs:
        ...
        attn_h = self.attn_net(last_obs_state, seq_start_end)  # 656, 32
        a = self.to_vel(torch.cat([last_obs_state, attn_h], dim=1))
